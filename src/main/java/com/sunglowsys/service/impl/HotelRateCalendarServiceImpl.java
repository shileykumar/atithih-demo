...
public class HotelRateCalendarServiceImpl implements HotelRateCalendarService {
    ...
    public Page<HotelRateCalendar> findAll(Pageable pageable) {
        log.debug("Request to find HotelRateCalendars");
        return hotelRateCalendarRepository.findAll(pageable);
    }

    @Override
    public Optional<HotelRateCalendar> findById(Integer id) {
        log.debug("Request to find HotelRateCalendar : {}", id);
        return hotelRateCalendarRepository.findById(id);
    }

    @Override
    public List<HotelRateCalendar> search(String searchText) {
        log.debug("Request to search HotelRateCalendar : {}", searchText);
        return null;
    }
